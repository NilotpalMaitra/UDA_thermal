...
class CNNModel(nn.Module):
    ...
    def __init__(self):
        ...
        self.class_classifier = nn.Sequential(
            nn.Linear(256 * 6 * 6, 100),  # Adjust the input size according to your input image size
            nn.BatchNorm1d(100),
            nn.ReLU(True),
            nn.Linear(100, 100),
            nn.BatchNorm1d(100),
        ...
        self.conv4 = nn.Conv2d(384, 128, kernel_size=3, dilation=2)
    ...
    def forward(self, input_data, alpha):
        ...
        feature = feature.view(-1, 256 * 6 * 6)  # Flatten the tensor appropriately
